---
title: "2026 NFL Draft ED Grades"
...
# Combine Datasets
```{r}
ed_values <- eds %>% left_join(defense, by = c("id" = "player_id")) %>% drop_na()
ed_values <- ed_values %>% left_join(prsh_defense, by = c("id" = "player_id")) %>% drop_na()
