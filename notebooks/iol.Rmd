---
title: "2026 NFL Draft IOL Grades"
...
# Combine Datasets
```{r}
iol_values <- iols %>% left_join(blocking, by = c("id" = "player_id")) %>% drop_na()
iol_values <- iol_values %>% left_join(run_blocking, by = c("id" = "player_id")) %>% drop_na()
